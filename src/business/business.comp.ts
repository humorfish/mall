...
import { TodoObjData, TodoData, NeedReadObjData, NoticeObjData, CommonFuncData } from './business.model';

@Component({selector: 'c-business-comp', templateUrl: './business.html', styleUrls: ['./business.scss']})
export class BusinessComp implements OnInit
{
    constructor()
    {}
    ...
    todoData: TodoData = {id: 0, title: 'aa', submitUser: '', createDate: ''};
    todoObj: TodoObjData = {
        total: 50,
        todoList: [{id: 1,
            title: '“张三”的采购订单审批',
